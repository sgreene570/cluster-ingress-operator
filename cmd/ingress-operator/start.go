...
func NewStartCommand() *cobra.Command {
	...
	cmd.Flags().StringVarP(&options.CanaryImage, "canary-image", "c", "", "image of the canary container that the operator will manage (required)")
	...
	if err := cmd.MarkFlagRequired("canary-image"); err != nil {
		panic(err)
	}
