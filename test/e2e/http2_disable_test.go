...
func TestRouteHTTP2EnableAndDisableIngressController(t *testing.T) {
	...
	if err := waitForRouterDeploymentHTTP2Disabled(t, kclient, routerDeployTimeout, ic, false); err != nil {
	...
	if err := waitForRouterDeploymentHTTP2Disabled(t, kclient, routerDeployTimeout, ic, true); err != nil {
...
func waitForRouterDeploymentHTTP2Disabled(t *testing.T, client client.Client, timeout time.Duration, c *operatorv1.IngressController, expectedDisabledStatus bool) error {
